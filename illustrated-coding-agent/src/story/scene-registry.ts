...
export const CHAPTER_SCENES: Record<ChapterId, SceneId[]> = {
  ...
  'toy-example': ['toy-read', 'toy-write', 'toy-test', 'toy-done'],
  'flight-recorder': [
    'first-loop',
    'tool-invocation',
    'permission-gate',
...
export const SCENE_DEFINITIONS: SceneDefinition[] = [
  ...
  },
  {
    ...
    contentBlockIds: ['toy-intro', 'toy-step-read'],
    targetSimulatorStateId: 'toy-read',
    annotations: [],
    allowedToggles: [],
    emphasis: 'simulator',
    requiresKeyInsight: true,
  ...
  },
  {
    sceneId: 'toy-write',
    chapterId: 'toy-example',
    contentBlockIds: ['toy-step-write'],
    targetSimulatorStateId: 'toy-write',
    annotations: [],
    allowedToggles: [],
    emphasis: 'simulator',
    requiresKeyInsight: true,
  ...
  },
  {
    sceneId: 'toy-test',
    chapterId: 'toy-example',
    contentBlockIds: ['toy-step-test'],
    targetSimulatorStateId: 'toy-test',
    annotations: [],
    allowedToggles: [],
    emphasis: 'simulator',
    requiresKeyInsight: true,
  },
  {
    sceneId: 'toy-done',
    chapterId: 'toy-example',
    contentBlockIds: ['toy-step-done'],
    targetSimulatorStateId: 'toy-done',
    annotations: [],
    allowedToggles: [],
    emphasis: 'narrative',
    requiresKeyInsight: true,
  },
  {
    ...
    contentBlockIds: ['loop-lens-onboarding', 'loop-lens-onboarding-harness', 'loop-intro', 'loop-request-intake'],
